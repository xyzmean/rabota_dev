...
**Текущий статус**: Основные функции реализованы, идёт интеграция с API
...
### В процессе:
- 🔄 Интеграция компонента графика с API
- 🔄 Миграция данных сотрудников из Local Storage на API

### Следующие шаги:
1. Заменить `useLocalStorage` на API вызовы для employees
2. Заменить `useLocalStorage` на API вызовы для schedule
3. Добавить обработку ошибок и loading states
4. Интегрировать систему ролей в UI
